...
def review_feature_spec(spec: str, feature_type: str = None, tracker=None) -> dict:
    """
...
def review_sections(spec: str, section_names: list[str], feature_type: str = None, tracker=None) -> dict:
    """
